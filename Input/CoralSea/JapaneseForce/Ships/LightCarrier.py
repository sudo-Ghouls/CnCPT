...
class LightCarrier(Ship):
    ...
    def behavior_startup(unit, simulation_manager):
        ...
        all_carriers = unit.my_LightCarriers
            ...
            if is_day(simulation_manager.now):
                if unit.search_mission is None:
                    unit.deploy_search_mission(unit.enemy_bearing, unit.enemy_distance,
                                               NakajimaB5NType97, 3, simulation_manager.now)
                else:
                ...
                if unit.target_located is True and unit.air_wing_mission is None:
                    air_wing_composition = {AichiD3AType99: 6,
                                            A6M2Zero: 8,
                                            NakajimaB5NType97: 2}
...
class Shoho(LightCarrier):
    def __init__(self, name="Shoho", behavior=LightCarrier.behavior_startup, location=None, spawn_polygon=None,
